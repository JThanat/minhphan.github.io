...
because $$z_n$$ is already $$i$$ we have picked from the beginning. The subsript $$n,d$$ or $$d$$ is just to express that we're only considering the word $$n$$ and document $$d$$.
