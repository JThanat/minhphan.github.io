...
Let $$z_n$$ the topic assignment of the $$n$$th word in current document. $$z_{n,i} = 1$$ when the topic assignment is the $$i$$th topic, 

otherwise $$z_{n,i} = 0$$. $$p(z_n|\theta)$$ is simply $$\theta_i$$ when $$z_{n,i}=1$$. 
