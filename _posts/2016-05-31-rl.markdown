...
> the binomial distribution with parameters n and p is the discrete probability distribution of \textbf{the number of successes in a sequence} of n independent experiments, each asking a yes–no question - Binomial distribution, Wikipedia
